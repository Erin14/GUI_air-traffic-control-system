...
public class PassengerAircraftTest {
    ...
    public void unloadTest() {
        assertNotEquals(0, aircraft1.calculateOccupancyLevel());
        aircraft1.unload();
        assertEquals(0, aircraft1.calculateOccupancyLevel());
        aircraft1.unload();
        assertEquals(0, aircraft1.calculateOccupancyLevel());

        assertEquals("ABC001:AIRBUS_A320:LOAD@0,TAKEOFF,AWAY,LAND:13600.00:false:0", aircraft1.encode());

        assertNotEquals(0, aircraft2.calculateOccupancyLevel());
        aircraft2.unload();
        assertEquals(0, aircraft2.calculateOccupancyLevel());

        assertEquals(0, emptyAircraft.calculateOccupancyLevel());

        assertNotEquals(0, fullAircraft.calculateOccupancyLevel());
        fullAircraft.unload();
        assertEquals(0, fullAircraft.calculateOccupancyLevel());
    }
