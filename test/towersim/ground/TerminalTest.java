...
public class TerminalTest {
    ...
    @Test
    public void equalsTest() throws NoSpaceException {
        assertFalse(airplaneTerminal.equals(helicopterTerminal));
        HelicopterTerminal abd = new HelicopterTerminal(2);
        airplaneTerminal.addGate(gate1);
        assertTrue(helicopterTerminal.equals(abd));
    }
    ...
    public void addGate_NoSpaceTest() {
        ...
        String sj = "AirplaneTerminal:1:false:0";
        assertEquals(sj, airplaneTerminal.encode());
