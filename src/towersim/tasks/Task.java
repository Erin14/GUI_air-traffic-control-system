...
public class Task implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        // convert the obj type from Object to Task
        Task givenTask = (Task) obj;
        return this.type.equals(givenTask.type)
                && this.loadPercent == givenTask.getLoadPercent();
    }
    ...
    public int hashCode() {
        ...
        return this.type.hashCode() * 3 + this.loadPercent * 7;
    }
}
