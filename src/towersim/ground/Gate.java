...
public class Gate implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        // convert the obj type from Object to Gate
        Gate givenGate = (Gate) obj;
        return this.gateNumber == givenGate.gateNumber;
    }
     ...
     * The callsign would be "empty" if the gate is unoccupied.
     *
