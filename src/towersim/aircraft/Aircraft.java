...
public abstract class Aircraft implements OccupancyLevel, Tickable, EmergencyState, Encodable {
     ...
     * For two aircraft to be equal, they must: 1) have the same callsign and 2) have the same
    ...
    public boolean equals(Object obj) {
        ...
        // convert the obj type from Object to Aircraft
        Aircraft givenAircraft = (Aircraft) obj;
        return this.callsign.equals(givenAircraft.callsign)
                && this.characteristics.equals(givenAircraft.characteristics);
    }
    ...
    @Override
    public int hashCode() {
        // choose the prime numbers 3 and 7 in this hashCode method
        return this.callsign.hashCode() * 3 + this.characteristics.hashCode() * 7;
    }
     ...
     * The format of the string to return is: callsign:model:taskListEncoded:fuelAmount:emergency.
     *
     * @return encoded string representation of this aircraft
     */
    @Override
    public String encode() {
        return String.format("%s:%s:%s:%.2f:%b",
                this.callsign,
